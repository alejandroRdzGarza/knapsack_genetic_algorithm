...
def one_point_crossover(elite, tam_pob):
    ...
    for i in range(middle_point):
        ...
        hijo1 = np.concatenate(papa[:random_point], mama[random_point:])
        hijo2 = np.concatenate(mama[:random_point], papa[random_point:])
